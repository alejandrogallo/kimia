...
#+RESULTS:
: (:TRANSLATE #<bytecompiled-function 0x219ea00> :DECLARE-VAR
:  #<bytecompiled-closure #<bytecompiled-function 0x3067960>> :DEFINE
:  #<bytecompiled-function 0x219e9b0>)
...
#+RESULTS:
: (:TRANSLATE #<bytecompiled-function 0x219e7d0> :DECLARE-VAR
:  #<bytecompiled-function 0x219e500> :DEFINE #<bytecompiled-function 0x219e4b0>)
...
#+RESULTS:
: (:TRANSLATE #<bytecompiled-function 0x1d81a50> :DECLARE-VAR
:  #<bytecompiled-function 0x1d81a00> :DEFINE #<bytecompiled-function 0x1d819b0>)
