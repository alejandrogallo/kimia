...
#+RESULTS:
: (:TRANSLATE #<bytecompiled-function 0x13fbe60> :DECLARE-VAR
:  #<bytecompiled-closure #<bytecompiled-function 0x21b0410>> :DEFINE
:  #<bytecompiled-function 0x13fbe10>)
...
#+RESULTS:
: (:TRANSLATE #<bytecompiled-function TRANSLATE-STRUCT-C++ 0x1b76500>
:  :DECLARE-VAR #<bytecompiled-function DECLARE-VAR-STRUCT-C++ 0x1b76550> :DEFINE
:  #<bytecompiled-function DEFINE-STRUCT-C++ 0x1b764b0>)
